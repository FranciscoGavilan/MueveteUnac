package com.example.mueveteunac2.viewUser.ui.view.viewLine;
...
import com.example.mueveteunac2.viewUser.ui.adapter.LineAdapter;
import com.example.mueveteunac2.viewUser.data.model.Line;
import com.example.mueveteunac2.viewUser.ui.view.viewLine.viewRoute.RouteActivity;
import com.example.mueveteunac2.viewUser.ui.viewModel.LineViewModel;
...
public class LineFragment extends Fragment{
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        lineViewModel.getLiveLinesFromFireStore().observe(getViewLifecycleOwner(), new Observer<List<Line>>() {
            @Override
